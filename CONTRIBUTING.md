Contributing to Blockade Core
============================

The Blockade Core project operates an open contributor model where anyone is
...
The following applies to code changes to the Blockade Core project, and is not to be
confused with overall Blockade Network Protocol consensus changes.

Whether a pull request is merged into Blockade Core rests with the project merge
...
Patches that change Blockade consensus rules are considerably more involved than
...
Where a patchset proposes to change the Blockade consensus, it must have been
...
The project leader is the release manager for each Blockade Core release.
