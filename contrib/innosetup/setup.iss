...
#define MyAppName "Blockade Core"
#define MyAppPublisher "2021 DECENOMY Core Developers"
#define MyAppURL "https://blockadecoin.net/"
#define MyAppExeName "blockade-qt.exe"
#define MyAppExtraData "https://explorer.decenomy.net/bootstraps/ADEC/bootstrap.zip"
...
DefaultDirName={autopf}\Blockade
...
OutputDir=.\output
OutputBaseFilename=BlockadeSetup
...
DefaultGroupName=Blockade Core
...
[Files]
Source: ".\package\blockade-qt.exe"; DestDir: "{app}"; Flags: ignoreversion; Components: app
...
[Registry]
Root: "HKCU"; Subkey: "Software\Blockade\Blockade-Qt"; ValueType: string; ValueName: "strDataDir"; ValueData: "{code:GetDataDir}\"
...
begin
  ...
  if DataDirPage.Values[0] = '' then
     DataDirPage.Values[0] := ExpandConstant('{reg:HKCU\Software\Blockade\Blockade-Qt,strDataDir|{userappdata}\Blockade\}');
  Result := True;
end;
