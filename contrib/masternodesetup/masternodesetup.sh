...
TMP_FOLDER=$(mktemp -d)
CONFIG_FILE='blockade.conf'
CONFIGFOLDER='/root/.blockade'
COIN_DAEMON='blockaded'
COIN_CLI='blockade-cli'
COIN_PATH='/usr/local/bin/'
COIN_TGZ=`curl -s https://api.github.com/repos/Blockade-Project/ADEC/releases/latest | grep "browser_download_url.*Linux\\.zip" | cut -d : -f 2,3 | tr -d \" | xargs`
