...
/* Blockade GUI -- Size of icons in status bar */
...
#define QAPP_ORG_NAME "Blockade"
#define QAPP_ORG_DOMAIN "blockade.org"
#define QAPP_APP_NAME_DEFAULT "Blockade-Qt"
#define QAPP_APP_NAME_TESTNET "Blockade-Qt-testnet"
