...
/** Utility functions used by the Blockade Qt UI.
 */
namespace GUIUtil
{
...
// Render ADEC addresses in monospace font
...
// Parse "blockade:" URI into recipient object, return true on successful parsing
