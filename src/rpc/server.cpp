...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* ADEC features */
        {"blockade", "listmasternodes", &listmasternodes, true },
        {"blockade", "getmasternodecount", &getmasternodecount, true },
        {"blockade", "createmasternodebroadcast", &createmasternodebroadcast, true },
        {"blockade", "decodemasternodebroadcast", &decodemasternodebroadcast, true },
        {"blockade", "relaymasternodebroadcast", &relaymasternodebroadcast, true },
        {"blockade", "masternodecurrent", &masternodecurrent, true },
        {"blockade", "startmasternode", &startmasternode, true },
        {"blockade", "createmasternodekey", &createmasternodekey, true },
        {"blockade", "getmasternodeoutputs", &getmasternodeoutputs, true },
        {"blockade", "listmasternodeconf", &listmasternodeconf, true },
        {"blockade", "getmasternodestatus", &getmasternodestatus, true },
        {"blockade", "getmasternodewinners", &getmasternodewinners, true },
        {"blockade", "getmasternodescores", &getmasternodescores, true },
        {"blockade", "preparebudget", &preparebudget, true },
        {"blockade", "submitbudget", &submitbudget, true },
        {"blockade", "mnbudgetvote", &mnbudgetvote, true },
        {"blockade", "getbudgetvotes", &getbudgetvotes, true },
        {"blockade", "getnextsuperblock", &getnextsuperblock, true },
        {"blockade", "getbudgetprojection", &getbudgetprojection, true },
        {"blockade", "getbudgetinfo", &getbudgetinfo, true },
        {"blockade", "mnbudgetrawvote", &mnbudgetrawvote, true },
        {"blockade", "mnfinalbudget", &mnfinalbudget, true },
        {"blockade", "checkbudgets", &checkbudgets, true },
        {"blockade", "mnsync", &mnsync, true },
        {"blockade", "spork", &spork, true },
...
{
    return "> blockade-cli " + methodname + " " + args + "\n";
}
