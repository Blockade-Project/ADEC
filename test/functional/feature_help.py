...
"""Verify that starting blockade with -h works as expected."""
import subprocess
...
class HelpTest(PivxTestFramework):
    ...
    def run_test(self):
        self.log.info("Start blockade with -? for help text")
        ...
        self.log.info("Start blockade with -version for version information")
